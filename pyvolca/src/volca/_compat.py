...
KNOWN_WIRE = 7
"""The newest wire revision this pyvolca understands (revision 7 adds editing
an activity's exchanges; revision 6 added explain_cf and the match_kind field
on flow contributions; revision 5 added writing activities; revision 4 added
the quality-report routes). An engine advertising more is newer than this
