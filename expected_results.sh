...
validate_inventory() {
    ...
    local result=$(env LD_LIBRARY_PATH="/home/dadafkas/projets/VoLCA/volca/petsc/arch-linux-c-debug/lib:/home/dadafkas/projets/VoLCA/volca/slepc/arch-linux-c-debug/lib" \
