    ...
    it "round-trips a small-exponent amount without scientific-notation loss" $ do
        ...
        let sdb =
                oneActivityDb
                    ...
                    [ TechnosphereExchange fProdU 1.0 fUnitU ReferenceProduct UUID.nil Nothing Nothing "" Nothing Nothing Nothing M.empty noProperties
  ...
  where
    ...
    prodAct nm prod =
        Activity
            ...
            LocationDeclared
            "kg"
            [TechnosphereExchange prod 1.0 moUnitU ReferenceProduct UUID.nil Nothing Nothing "" Nothing Nothing Nothing M.empty noProperties]
            M.empty
            M.empty
            Nothing
            Nothing
...
refProductEx = TechnosphereExchange fProdU 1.0 fUnitU ReferenceProduct UUID.nil Nothing Nothing "" Nothing Nothing Nothing M.empty noProperties
