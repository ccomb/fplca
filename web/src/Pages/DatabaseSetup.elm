        ...
        DatabaseSetupViewMsg viewMsg ->
            case viewMsg of
                ...
                DatabaseSetupView.GoToActivities ->
                    ( model
                    , Effect.fromCmd (Nav.pushUrl shared.key (Route.routeToUrl (Route.ActivitiesRoute { db = model.dbName, name = Nothing, product = Nothing, limit = Just 20, classifications = [] })))
                    )
